...
export function AddEmployeeModal({ isOpen, onClose }: { isOpen: boolean, onClose: () => void }) {
  ...
  const saveEmployee = async (employeeData: { username: string;  role: string; password: string }) => {
    setIsLoading(true);
    try {
        ...
        <DialogHeader>
          ...
          <>
            ...
            <DialogFooter className="flex justify-end mt-4 space-x-2">
              ...
              <Button type="button" onClick={handleSave} className="bg-purple-700 text-white hover:bg-primary-dark">
